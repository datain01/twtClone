...
const TweetPage = () => {
  ...
  const { authenticated, user } = useAuth(); //로그인 시에만 답글 작성 input을 보여주게 하기위해 인증
          ...
          <div className="d-flex justify-content-between">
            ...
            >
              <ArrowRepeat
                width="20"
                height="20"
                fill={post.userRetweet ? "#38B2AC" : "grey"}
              />
            </button>
            {/* 좋아요 */}
            <button
            ...
            <div className="d-flex justify-content-between">
              ...
              >
                <ArrowRepeat
                  width="20"
                  height="20"
                  fill={reply.userRetweet ? "green" : "grey"}
                />
              </button>
              <button
                type="button"
